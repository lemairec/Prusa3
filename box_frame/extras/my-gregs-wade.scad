...
idler_fulcrum_offset=608_diameter/2+4+m3_diameter/2;
...
echo("bhmh", mounting_holes)
	...
	translate(large_wheel_translation)
	{
			...
			rotate([90,0,180])
			rotate(360/16)
			cylinder(r=filament_feed_hole_d*0.65,h=wade_block_depth*3,center=false,$fn=8);	
